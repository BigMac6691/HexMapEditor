class EdgeEditor extends FeatureEditor
{
    constructor(map)
    {
        ...
        "<p>An edge has depth (which is why it is not called side).  It is a trapezoid with a short side width of about &frac12; the side length and a height of about &#8529; the bounding rectangle height like so:</p>" +
